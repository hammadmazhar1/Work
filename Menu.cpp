...
bool Menu::init() {
	...
	logo = SceneManager::func_createImage("heading.png",0,1,270,680);
	this->addChild(logo,1);
	play = SceneManager::func_createImage("menuplay.png",0,1,350,380);
	this->addChild(play,1);
	options= SceneManager::func_createImage("menuoptions.png",0,1,30,60);
	this->addChild(options,1);
	store = SceneManager::func_createImage("menustore.png",0,1,730,60);
	this->addChild(store,1);
	playhover = SceneManager::func_createImage("playhover.png",0,1,347,380);
	this->addChild(playhover,1);
	playhover->setVisible(false);
	storehover = SceneManager::func_createImage("storehover.png",0,1,728,60);
	this->addChild(storehover,1);
	storehover->setVisible(false);
	ophover = SceneManager::func_createImage("optionshover.png",0,1,28,60);
	this->addChild(ophover,1);
	ophover->setVisible(false);
	AnimateCounter = 0;
